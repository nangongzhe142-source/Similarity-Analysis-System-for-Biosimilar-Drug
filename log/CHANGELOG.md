...
> 倒序排列。详细文件见同目录下 `2026-08-14-s*.md`、`2026-08-20-p*.md`、`2026-08-21-p*.md`、`2026-08-22-p*.md`、`2026-08-30-p*.md`。

---

## 2026-08-30 — P26 非一级结构曲线比对演示

**状态**：Done。详见 [`2026-08-30-p26-曲线比对演示.md`](./2026-08-30-p26-曲线比对演示.md)。

SEC 聚集体、酸性电荷变异体、远紫外 CD 三条主方法共用 `curve-overlay`。合成夹具、Pearson / 面积%、叠加图；verdict 固定 REVIEW。
